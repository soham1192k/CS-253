...
#IPL most sixes
# srate=[150.11]
srate=list(map(float,data_list[24]))
# sixes=[349]
sixes=list(map(int,data_list[25]))
plt.scatter(srate,sixes,c='r')
# srate=[151.91]
srate=list(map(float,data_list[26]))
# sixes=[235]
sixes=list(map(int,data_list[27]))
plt.scatter(srate,sixes,c='b')
# srate=[136.75]
srate=list(map(float,data_list[28]))
# sixes=[216]
sixes=list(map(int,data_list[29]))
plt.scatter(srate,sixes,c='m')
# srate=[130.61]
srate=list(map(float,data_list[30]))
# sixes=[213]
sixes=list(map(int,data_list[31]))
plt.scatter(srate,sixes,c='g')
# srate=[130.73]
srate=list(map(float,data_list[32]))
# sixes=[201]
sixes=list(map(int,data_list[33]))
plt.scatter(srate,sixes,c='k')
# srate=[149.87]
srate=list(map(float,data_list[34]))
# sixes=[198]
sixes=list(map(int,data_list[35]))
plt.scatter(srate,sixes,c='c')
# srate=[141.54]
srate=list(map(float,data_list[36]))
# sixes=[195]
sixes=list(map(int,data_list[37]))
plt.scatter(srate,sixes,c='y')
# srate=[137.14]
srate=list(map(float,data_list[38]))
# sixes=[194]
sixes=list(map(int,data_list[39]))
plt.scatter(srate,sixes,c='lime')
# srate=[137.91]
srate=list(map(float,data_list[40]))
# sixes=[190]
sixes=list(map(int,data_list[41]))
plt.scatter(srate,sixes,c='orange')
# srate=[129.99]
srate=list(map(float,data_list[42]))
# sixes=[163]
sixes=list(map(int,data_list[43]))
