In this assignment, we are covering topics like file descriptors, processes & simple unix bash scripting. There are a lot of cool tools that are available on almost all Linux Distros.
